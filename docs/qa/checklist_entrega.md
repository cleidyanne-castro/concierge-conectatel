...
- [ ] Parte 0: líder, papéis e integração/auditoria definidos.
- [ ] Parte 1: limpeza, três análises e achado ligado a decisão de design.
- [ ] Parte 2: chunking, embeddings, índice e filtro `status=vigente` antes do score.
